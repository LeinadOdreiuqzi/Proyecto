...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="pag_principal.php">Navbar</a>
        ...
        <div class="content-container">
            ...
            <form class="col-4 p-3" method="POST" action="">
                ...
                <div class="mb-3">
                    ...
                    <select name="estado" class="form-control" id="estado" <?php echo $_GET['edit_estado'] ?? ''; ?>>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['btnregistrar']) && $_POST['btnregistrar'] == 'ok') {
                            ...
                            $query = "INSERT INTO registro_compras (fecha, proveedor, total, descripcion, metodo_pago, estado) VALUES ('$fecha', '$proveedor', '$total', '$descripcion', '$metodo_pago', '$estado')";
                        ...
                        if (isset($_POST['btneditar']) && $_POST['btneditar'] == 'ok') {
                            ...
                            $query = "UPDATE registro_compras SET fecha='$fecha',proveedor='$proveedor',total='$total',descripcion='$descripcion',metodo_pago='$metodo_pago',estado='$estado' WHERE id='$id'";
                            if (mysqli_query($conectar, $query)) {
                                header("Location: registro_compras.php?status=uptaded");
                                exit();
                            } else {
                        ...
                        $sql = "SELECT id, fecha, proveedor, total, descripcion, metodo_pago, estado FROM registro_compras";
                        ...
                        if ($result) {
                            ...
                            while ($datos = $result->fetch_assoc()) {
                                ...
                                echo "<td>";
                                // Botón Editar
                                echo '<a href="registro_compras.php?edit_id=' . $datos['id'] . '&edit_id=' . $datos['fecha'] . '&edit_fecha=' . $datos['proveedor'] . '&edit_proveedor=' . $datos['total'] . '&edit_total=' . $datos['descripcion'] . '&edit_descripcion=' . $datos['metodo_pago'] . '&edit_metodo_pago=' . $datos['estado'] .  '" class="btn btn-small btn-warning">Editar</a> ';
                                // Botón Eliminar
